...
export interface IPipe<T extends any[], R> {
	...
	<R1 extends R, R2 extends R>(f1: (...args: T) => R1, f2: (a: R1) => R2): R2 extends Iterable<infer U>
		? IPipeWrapper<U>
		: any;
	...
	<R1 extends R, R2 extends R, R3 extends R, R4 extends R, R5 extends R, R6 extends R>(
		f1: (...args: T) => R1,
		f2: (a: R1) => R2,
		f3: (a: R2) => R3,
		f4: (a: R3) => R4,
	...
	<R1 extends R, R2 extends R, R3 extends R, R4 extends R, R5 extends R, R6 extends R, R7 extends R>(
		f1: (...args: T) => R1,
		f2: (a: R1) => R2,
		f3: (a: R2) => R3,
		f4: (a: R3) => R4,
